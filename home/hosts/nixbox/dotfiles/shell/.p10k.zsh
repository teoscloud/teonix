# Generated by Powerlevel10k configuration wizard on 2024-09-02 at 17:16 CEST.
...
# 2 lines, disconnected, left frame, white-ornaments, sparse, few icons, fluent,
...
() {
  ...
  # Include Mullvad WireGuard interfaces (wg*-mullvad / mullvad-*)
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun)|tailscale|mullvad)[0-9]*|(zt.*)|(.*mullvad.*)'
