...
in {
  ...
  # Lua config (hyprlang .conf is deprecated since 0.55, removed in 0.57).
  ...
  # A running legacy-parser Hyprland writes a stub hyprland.conf (autogenerated = 1,
  # six default binds, dwindle) the moment its .conf disappears — which is exactly
  # what the switch to hyprland.lua did mid-activation (2026-09-22). Delete only
  # such stubs, never a real config.
